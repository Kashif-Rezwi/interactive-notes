...
**Governed-generation status:** The **active benchmark is [BMK-2026-0001](../../../records/benchmarks/bmk-2026-0001-linear-algebra-foundations-v4.md)** (CAN-2026-0003, `linear-algebra-foundations-v4.html`, EVAL-2026-0002; per [ADR-0011](../../../docs/adr/0011-benchmark-definition-and-artifact-change-protocol.md)). The **current reference candidate for new authoring is `linear-algebra-foundations-v9.html`** (candidate CAN-2026-0008), generated under [RUN-20260903-0001](../../../records/runs/run-20260903-0001-linear-algebra-foundations-v9.md) as the prompt-card @0.6.0 autonomous comparison run (first governed use; component layout contracts §10.6–§10.8, formula manifest, term definition registry, and structured assessment modality); it closed as `private-pilot-complete` under a non-independent review ([EVAL-2026-0009](../../../records/evaluations/eval-2026-0009-linear-algebra-foundations-v9.md), weighted 3.58, degraded-mode Audit 6) — the comparison judged the @0.6.0 hypothesis **supported** (all 5 failure classes resolved in a single generation) — and is **not a public release, benchmark result, or efficacy claim**. The previous reference candidate `linear-algebra-foundations-v8.html` (CAN-2026-0007, RUN-20260815-0002, EVAL-2026-0008) is superseded and preserved as a historical version. Earlier candidates — v1 (historical), v2 (CAN-2026-0001), v3 (CAN-2026-0002), v4 (CAN-2026-0003), v5 (CAN-2026-0004), v6 (CAN-2026-0005), v7 (CAN-2026-0006) — are preserved as historical versions; see the Version history table below and the run ledgers of the governed candidates (v1, preserved from the initial commit, has no reconstructable run or evaluation record).
...
| | Interactive notes — **reference version** (CAN-2026-0008, v9; non-independent review; not released) | [Open the v9 notes](generated/linear-algebra-foundations-v9.html) |
| | Interactive notes — **previous reference** (CAN-2026-0007, v8; non-independent review; not released; superseded by v9) | [Open v8 (historical)](generated/linear-algebra-foundations-v8.html) |
