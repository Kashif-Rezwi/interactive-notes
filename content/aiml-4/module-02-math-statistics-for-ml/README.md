...
**Governed-generation status:** The **active benchmark is [BMK-2026-0001](../../../records/benchmarks/bmk-2026-0001-linear-algebra-foundations-v4.md)** (CAN-2026-0003, `linear-algebra-foundations-v4.html`, EVAL-2026-0002; per [ADR-0011](../../../docs/adr/0011-benchmark-definition-and-artifact-change-protocol.md)). The **current reference candidate for new authoring is `linear-algebra-foundations-v8.html`** (candidate CAN-2026-0007), generated under [RUN-20260815-0002](../../../records/runs/run-20260815-0002-linear-algebra-foundations-v8.md) as the prompt-card @0.5.0 comparison run (first governed use; engineering remediation of v7's canvas and design-system regressions); it closed as `private-pilot-complete` under a non-independent review ([EVAL-2026-0008](../../../records/evaluations/eval-2026-0008-linear-algebra-foundations-v8.md), weighted 3.85, **live browser mode Audit 6**) — the comparison judged the @0.5.0 hypothesis **supported** (canvas engineering standard + design-system contract prevented the v7 regression class in a single generation) — and is **not a public release, benchmark result, or efficacy claim**. The previous reference candidate `linear-algebra-foundations-v7.html` (CAN-2026-0006, RUN-20260815-0001, degraded-mode Audit 6) is superseded and preserved as a historical version. Earlier candidates — v1 (historical), v2 (CAN-2026-0001), v3 (CAN-2026-0002), v4 (CAN-2026-0003), v5 (CAN-2026-0004) — are preserved as historical versions; see the Version history table below and the run ledgers of the governed candidates (v1, preserved from the initial commit, has no reconstructable run or evaluation record).
...
| | Interactive notes — **reference version** (CAN-2026-0007, v8; non-independent review; not released) | [Open the v8 notes](generated/linear-algebra-foundations-v8.html) |
| | Interactive notes — **previous reproduction** (CAN-2026-0006, v7; non-independent review; not released; superseded by v8) | [Open v7 (historical)](generated/linear-algebra-foundations-v7.html) |
