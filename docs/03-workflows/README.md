...
This directory specifies how accountable work moves through Learning OS. A workflow consumes named artifacts, produces named artifacts, records evidence, and has explicit entry/exit conditions.
