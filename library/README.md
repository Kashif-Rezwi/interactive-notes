...
| Directory | Purpose |
| --- | --- |
| `prompts/` | Approved, versioned prompt cards ready for governed reuse |
| `rubrics/` | Approved reusable rubrics, dimension guides, and calibration exemplars |
| `patterns/` | Curated teaching, interaction, visualization, and accessibility patterns |
| `references/` | Rights-aware research/source reference summaries and citation metadata |
