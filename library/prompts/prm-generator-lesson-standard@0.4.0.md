...
**Last evaluated:** 2026-08-13 — first governed use [RUN-20260813-0002](../../records/runs/run-20260813-0002-linear-algebra-foundations-v6.md) (candidate CAN-2026-0005) on the frozen evaluation set, doubling as the comparison run for the 0.4.0 hypothesis: **supported** ([EVAL-2026-0004](../../records/evaluations/eval-2026-0004-linear-algebra-foundations-v6.md), weighted 3.76; reference-band depth restored in a single generation)  
