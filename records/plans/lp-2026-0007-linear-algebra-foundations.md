# LP-2026-0007: Learning plan for linear algebra foundations v9 (@0.6.0 autonomous comparison run)

**Status:** Reviewed<br>
**Supersedes / iteration position:** Iteration 4 — supersedes [LP-2026-0006](../plans/lp-2026-0006-linear-algebra-foundations.md) (same unchanged source, same validated teaching order and depth bar; this iteration incorporates prompt-card @0.6.0 obligations: component layout contracts for sliders [§10.6] and option stacks [§10.7], callout discipline [§10.8], formula manifest, term definition registry, and assessment modality constraints prohibiting unconstrained `<textarea>` fields in checks)<br>
**Owner:** Repository maintainer (solo Stage 1 operator, Creator profile)<br>
**Concept model:** [CM-2026-0006](../concepts/cm-2026-0006-linear-algebra-foundations.md)<br>
...
**Source and claim links:** [SRC-2026-0001](../sources/src-2026-0001-aiml-4-module-02.md); all claims anchor per CM-2026-0006; added bridges labeled FOUNDATION, enrichments DEEP DIVE/EXTENSION
