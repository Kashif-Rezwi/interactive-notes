# XS-2026-0007: Interactive notes candidate `linear-algebra-foundations-v9.html` (CAN-2026-0008)

**Status:** Approved<br>
**Approval scope:** Stage 1 governed generation<br>
**Supersedes / iteration position:** Iteration 4 — supersedes [XS-2026-0006](../specifications/xs-2026-0006-linear-algebra-foundations-v8.md) (this iteration incorporates prompt-card @0.6.0 specifications: component layout contracts for sliders [§10.6] and option stacks [§10.7], callout discipline [§10.8], Formula Manifest, Term Definition Registry, and strict assessment modality constraints forbidding open `<textarea>` fields in checks)<br>
**Source concept model:** [CM-2026-0006](../concepts/cm-2026-0006-linear-algebra-foundations.md)<br>
**Learning plan:** [LP-2026-0007](../plans/lp-2026-0007-linear-algebra-foundations.md)<br>
...
**Learning outcomes:** All twelve outcomes of LP-2026-0007; every computational skill has its own faded ladder; every unit check contains auto-evaluated diagnostic items.

## Learner problem and teaching strategy

The learner meets linear algebra as abstract notation. The candidate invests in deep intuition, responsive manipulables, prediction gates, faded ladders, and disciplined layout. This build evaluates prompt card `prm-generator-lesson-standard@0.6.0`: enforcing atomic slider encapsulation (§10.6), vertical option stacks (§10.7), callout discipline (§10.8), comprehensive formula keys, direct term definition without cop-outs, and zero open textareas.
